...
void HelloTriangleApplication::createGraphicsPipeline() {
    ...
    vk::GraphicsPipelineCreateInfo pipelineInfo{
        .pNext =
            &pipelineRenderingCreateInfo,  // add pNext to link to Pipeline Rendering Create Info
...
[[nodiscard]] vk::raii::ShaderModule HelloTriangleApplication::createShaderModule(
