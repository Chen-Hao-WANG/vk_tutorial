...
void HelloTriangleApplication::createDescriptorPool() {
    ...
    */
    ...
    // uniform buffer
    poolSizes[0] = vk::DescriptorPoolSize{.type = vk::DescriptorType::eUniformBuffer,
                                          .descriptorCount = MAX_FRAMES_IN_FLIGHT + 10};
    // texture sampler
    poolSizes[1] = vk::DescriptorPoolSize{.type = vk::DescriptorType::eCombinedImageSampler,
                                          .descriptorCount = MAX_FRAMES_IN_FLIGHT + 10};
    // light buffer
    ...
    vk::DescriptorPoolCreateInfo poolInfo{
        ...
        .maxSets = static_cast<uint32_t>(
            MAX_FRAMES_IN_FLIGHT + 10),  // total number of descriptor sets that can be allocated
...
void HelloTriangleApplication::createComputeDescriptorSetLayout() {
    ...
    */
    ...
    // Binding 3: Storage Image (Output Image)
    bindings[3] =
