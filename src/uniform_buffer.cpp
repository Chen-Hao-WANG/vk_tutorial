...
void HelloTriangleApplication::updateUniformBuffer(uint32_t currentImage) {
    ...
    2. it is not efficient to update the uniform buffer every frame for multiple frames in flight,
    better to use push constants or dynamic uniform buffers for larger data
